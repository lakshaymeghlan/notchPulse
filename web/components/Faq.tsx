...
const ITEMS = [
  ...
  { q: "macOS says it “could not verify” NotchPulse (or that it’s damaged).", a: "NotchPulse isn’t notarized by Apple yet, so macOS quarantines downloads. Unzip it and move NotchPulse to Applications, then try to open it once. On macOS 15/26: go to System Settings → Privacy & Security, scroll to Security, and click “Open Anyway” next to NotchPulse, then confirm. (Fastest: run `xattr -dr com.apple.quarantine /path/to/NotchPulse.app` in Terminal, then open it.) It’s safe and open-source — the warning just means it isn’t signed with a paid Apple certificate yet." },
